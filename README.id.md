...
SDK Go **tidak resmi** untuk API Payment Gateway GSPAY2. SDK ini menyediakan [antarmuka Go](https://go.dev/doc/effective_go) yang komprehensif dan idiomatik untuk pemrosesan pembayaran, pencairan dana, dan pengecekan saldo.
